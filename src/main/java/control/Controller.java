...
/**
 * clase para gestionar las operaciones para el cálculo de la integración numérica de la distribución T  
 * @class  Controller
...
public class Controller {
    ...
    /**
     * Métodod que retorna la distribución T con el valor numérico de integración p

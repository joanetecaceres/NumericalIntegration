...
public class ControllerTest {
    ...
    public void testCalculateIntegrationFunction() {
        ...
        assertEquals("error en la distribución t1 ", 0.35006, (double)Math.round(TestCase1.getP() * 100000) / 100000, TDistribution1.getErrorValue());
        ...
        assertEquals("error en la distribución t2 ", 0.36757, (double)Math.round(TestCase2.getP() * 100000) / 100000, TDistribution2.getErrorValue());
        ...
        assertEquals("error en la distribución t3 ", 0.49500, (double)Math.round(TestCase3.getP() * 100000) / 100000, TDistribution3.getErrorValue());      
    }
